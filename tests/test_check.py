...
class TestCheck(TestCase):
    ...
    def test_checkdateofbirthA(self):
        s = Check
        self.assertTrue(s.checkdateofbirth('08201996'))

    def test_checkdateofbirthB(self):
        s = Check
        self.assertFalse(s.checkdateofbirth('01361996'))

    def test_checkdateofbirthC(self):
        s = Check
        self.assertFalse(s.checkdateofbirth('13201996'))

    def test_checkdateofbirthD(self):
        s = Check
        self.assertFalse(s.checkdateofbirth('03321996'))

    def test_checkdateofbirthE(self):
        s = Check
        self.assertFalse(s.checkdateofbirth('02281996'))

    def test_checkdateofbirthF(self):
        s = Check
        self.assertFalse(s.checkdateofbirth('02291997'))

    def test_checkdateofbirthG(self):
        s = Check
        self.assertFalse(s.checkdateofbirth('06202020'))
